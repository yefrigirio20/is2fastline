...
<!-- 
    ...
    Created on : 21/12/2008, 07:28:12 PM
    Author     : itachi
-->
            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="-rave-layout: grid">
                    <webuijsf:form id="form1">
                        <webuijsf:label id="label1" style="height: 22px; left: 24px; top: 72px; position: absolute; width: 286px" text="Fuentes Rivera José  &#xa;"/>
                        <webuijsf:label id="label2" style="height: 22px; left: 24px; top: 96px; position: absolute; width: 286px" text="Huachani Villcas Angel&#xa;"/>
