                ...
                <webuijsf:body id="body1" style="background-color: rgb(139, 175, 228); -rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:hyperlink actionExpression="#{FastLine.administracion_action}" id="administracion"
                            style="left: 24px; top: 576px; position: absolute" text="Administración"/>
                        ...
                        <webuijsf:hyperlink actionExpression="#{FastLine.reservarPasajes_action}" id="reservarPasajes"
                            style="left: 24px; top: 552px; position: absolute" text="Reservar Pasajes"/>
                        <webuijsf:image height="24" id="image2" style="left: 0px; top: 576px; position: absolute" url="/resources/utilities.png" width="24"/>
                        <webuijsf:image height="24" id="image4" style="left: 0px; top: 552px; position: absolute" url="/resources/lassists.png" width="24"/>
                        ...
                        <webuijsf:label binding="#{FastLine.userLabel}" id="userLabel"
                            style="left: 24px; top: 96px; position: absolute; text-align: right; width: 72px" text="Usuario:"/>
                        <webuijsf:label binding="#{FastLine.passLabel}" id="passLabel"
                            style="left: 0px; top: 120px; position: absolute; text-align: right; width: 96px" text="Contraseña:"/>
                        <webuijsf:textField binding="#{FastLine.userName1}" id="userName1"
                            onKeyUp="DynaFaces.Tx.fire(&quot;ajaxTransaction1&quot;, &quot;userName1&quot;) " style="left: 96px; top: 96px; position: absolute" valueChangeListenerExpression="#{FastLine.userName1_processValueChange}"/>
                        <webuijsf:passwordField binding="#{FastLine.pass1}" id="pass1" style="left: 96px; top: 120px; position: absolute"/>
                        <webuijsf:staticText binding="#{FastLine.mensajelogginLabel}" id="mensajelogginLabel"
                            style="height: 22px; left: 0px; top: 72px; position: absolute; width: 262px" text="Ingrese su nombre de usuario y su contraseña"/>
                        <webuijsf:button actionExpression="#{FastLine.iniciarSesion_action}" binding="#{FastLine.iniciarSesion}" id="iniciarSesion"
                            ...
                            style="height: 24px; left: 95px; top: 144px; position: absolute; width: 96px" text="Iniciar Sesión"/>
                        <webuijsf:staticText id="staticText3" style="left: 24px; top: 168px; position: absolute; width: 142px" text="Para    registrarte has click"/>
                        <webuijsf:hyperlink actionExpression="#{FastLine.nuevoUsuario_action}" id="nuevoUsuario1"
                            style="left: 168px; top: 168px; position: absolute" text="aqui"/>
                        <webuijsf:staticText binding="#{FastLine.error}" id="error" style="color: red; font-size: 14px; height: 24px; left: 24px; top: 504px; position: absolute; width: 168px"/>
                        ...
                        <div style="height: 478px; left: 408px; top: 24px; position: absolute; width: 574px">
