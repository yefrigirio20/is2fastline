            ...
            <webuijsf:html id="html1">
                ...
                <webuijsf:body id="body1" style="background-color: rgb(255, 255, 255); -rave-layout: grid">
                    <webuijsf:form id="form1">
                        ...
                        <webuijsf:hyperlink actionExpression="#{FastLine.reservarPasajes_action}" binding="#{FastLine.reservarPasajes}" id="reservarPasajes"
                            style="left: 24px; top: 144px; position: absolute" text="Reservar Pasajes"/>
                        ...
                        <webuijsf:staticText binding="#{FastLine.registrarseClick}" id="registrarseClick"
                            style="left: 24px; top: 168px; position: absolute; width: 142px" text="Para    registrarte has click"/>
